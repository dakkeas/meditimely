import { StyleSheet, ScrollView, Button, Pressable, Modal, StatusBar, Dimensions, BackHandler} from 'react-native';
...
export default function TabOneScreen() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <StatusBar backgroundColor='green' barStyle="dark-content" hidden></StatusBar>
